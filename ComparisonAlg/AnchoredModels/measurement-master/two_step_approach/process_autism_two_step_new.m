...
[B,W_m,WW_m,y_m] = two_step_CD(Data');
...
% end
% load init_autism.mat

% refine the initialization value
W_init = natural_grad_Adasize_Mask(Data',Mask,WW_m);
...
[y_group, W_group] = W_adasize_groupwise_sparse(1 * log(TT)/2 , Mask, W_init, x_all);
